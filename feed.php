    ...
    <div class="modal-content login-modal">
      <div class="modal-header login-modal-header">
       ...
       <h4>Select files from your computer</h4>
          <form action="upload.php" method="post" enctype="multipart/form-data" id="js-upload-form" role="form">
            <div class="form-inline">
              <div class="form-group">
                <input type="file" name="userFile" id="js-upload-files" onchange="readURL(this);">
         ...
         <textarea class="inputs2" rows="1" name="caption"> Enter Caption...</textarea>
     
  <input type="radio" name="restrict" id="rad1" onclick="addInput('dynamicInput');">Private</input>
  <input type="radio" name="restrict" id="rad2">Public</input>

  <input type="submit" class="post" name="upload"></input>
  <br>
			...
			<div class=" col-sm-12 col-md-8 col-lg-8">
				<div class="row">
					<div class="leftbar_content">
						<h2>Recent Posts</h2>
<?php
$query = mysql_query("Select * from posts ORDER BY post_id DESC") or die(mysql_error());
if(isset($_GET['search']))
{
	...
	<div class="single_stuff wow fadeInDown">
		...
		$query1=mysql_query("Select * from comments where post_id=".$row['post_id']." ORDER BY timestamp") or die(mysql_error());
